  ...
  private buildChartComposicionCarrera(res: EstadisticasGeneroResponse): void {
    ...
    const abreviar = (s: string): string => {
      const mapa: Record<string, string> = {
        ...
        'Ingeniería en Sistemas Computacionales (Presencial / Virtual)': 'Ing. Sis. Comp.',
        'Ingeniería en Gestión Empresarial': 'Ing. Gest. Emp.',
        'Ingeniería Tecnologías de la Información y Comunicaciones (TIC\'s)': 'Ing. TIC\'s',
        'Ingeniería Informática': 'Ing. Informática',
        'Licenciatura en Administración (Presencial / A distancia)': 'Lic. Admin.',
        'Maestría': 'Maestría',
        'Posgrado': 'Posgrado',
      };
      return mapa[s] ?? s;
