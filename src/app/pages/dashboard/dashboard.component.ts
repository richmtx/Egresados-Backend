...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  private abreviarNombre(nombre: string): string {
    const abreviaciones: Record<string, string> = {
      ...
      'ingeniería en sistemas computacionales (presencial / virtual)': 'Ing. Sist.',
      'ingeniería en gestión empresarial': 'Ing. Gest.',
      "ingeniería tecnologías de la información y comunicaciones (tic's)": "Ing. TIC's",
      'ingeniería informática': 'Ing. Info.',
      'licenciatura en administración (presencial / a distancia)': 'Lic. Adm.',
      'maestría': 'Maestría',
      'posgrado': 'Posgrado',
